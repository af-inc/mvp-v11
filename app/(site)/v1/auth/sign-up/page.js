        ...
        <div className="flex flex-1 flex-col items-center justify-center px-4 sm:px-6 lg:px-8 bg-white">
          <div className="w-full max-w-sm h-screen">
            ...
            <div className="space-y-2">
              <h1 className="text-3xl pt-14 font-extrabold tracking-tight">Join us</h1>
              <p className="text-sm text-muted-foreground">
                Signup with Google or enter your credentials.
              </p>
            </div>
            ...
            <div className="py-3">
              ...
              <div className="space-y-4 mt-5">
                <div className="space-y-2">
                  ...
                  <Input id="name" type="text" placeholder="Your legal name" required/>
                </div>
                <div className="space-y-2">
              ...
              <div className="text-center text-sm p-3">
                ...
                <Link href="/v1/auth/sign-in" className="font-medium text-primary hover:underline">
                  Signin
                </Link>
              </div>
            </div>
